<script lang="ts">
	...
	import { Command } from 'lucide-svelte'; // Import the Command icon from lucide-svelte
...
<div class="flex flex-wrap items-center justify-center py-4 md:py-8">
	...
	<div class="relative order-last mx-5 mb-2 w-fit md:order-none">
		<Input
			...
			class="rounded-md border border-blue-300 px-3 py-2 placeholder-blue-500 focus:border-green-500 focus:outline-none focus:ring-green-500 sm:text-sm"
		/>
