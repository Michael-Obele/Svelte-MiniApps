	...
	<div class="relative w-full max-w-(--breakpoint-xl)">
		<div class="relative flex flex-col items-center">
			<div class="mb-5 flex justify-center">
				<div
					class="flex size-60 flex-row items-center transition-transform hover:scale-105 sm:size-96"
				>
					{#if page.status === 404}
						<NF />
					{:else}
			...
			<div class="max-w-2xl space-y-6 px-4 text-center md:px-6">
				...
				<div
					class="mt-6 overflow-hidden rounded-lg border border-gray-200 bg-gray-50 dark:border-white/10 dark:bg-gray-800/50"
				>
					<div
						class="border-b border-gray-200 bg-white px-4 py-3 dark:border-white/10 dark:bg-gray-800"
					>
					...
					<div class="space-y-3 px-4 py-3 text-left">
						<div class="flex items-center space-x-3">
							...
							<code
								class="rounded bg-gray-100 px-2 py-0.5 font-mono text-sm text-gray-900 dark:bg-gray-700 dark:text-gray-300"
							>
								{page.status}
							</code>
						</div>
