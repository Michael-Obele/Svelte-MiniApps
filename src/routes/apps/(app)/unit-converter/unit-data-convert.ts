...
export const units: Record<UnitType, UnitOption[]> = {
	...
	area: [
		...
		{ value: 'squarechain', label: 'Square Chain' },
		{ value: 'squarelink', label: 'Square Link' },
		{ value: 'square rod', label: 'Square Rod' }
	],
	time: [
	...
	energy: [
		...
		{ value: 'megawatthour', label: 'Megawatt Hour (MWh)' },
		{ value: 'gigawatthour', label: 'Gigawatt Hour (GWh)' },
		{ value: 'terawatthour', label: 'Terawatt Hour (TWh)' },
		{ value: 'petawatthour', label: 'Petawatt Hour (PWh)' },
		{ value: 'btu', label: 'British Thermal Unit (BTU)' },
		{ value: 'therm', label: 'Therm' },
		{ value: 'footpound', label: 'Foot Pound (ft⋅lb)' },
		{ value: 'inchpound', label: 'Inch Pound (in⋅lb)' },
		{ value: 'erg', label: 'Erg' },
		{ value: 'electronvolt', label: 'Electronvolt (eV)' },
		{ value: 'millielectronvolt', label: 'Millielectronvolt (meV)' },
		{ value: 'kiloelectronvolt', label: 'Kiloelectronvolt (keV)' },
		{ value: 'megaelectronvolt', label: 'Megaelectronvolt (MeV)' },
		{ value: 'gigaelectronvolt', label: 'Gigaelectronvolt (GeV)' },
		{ value: 'teraelectronvolt', label: 'Teraelectronvolt (TeV)' },
		{ value: 'petaelectronvolt', label: 'Petaelectronvolt (PeV)' }
	],
	force: [
