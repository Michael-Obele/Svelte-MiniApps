...
<section class="p-4 text-center">
	...
	<p class="mb-4 text-lg">
		We're currently working on migrating this app to a new version. Please check back later.
	</p>
	<p class="mb-4 text-sm">
		You can still access the <a
			href="https://old.svelte-apps.me/{$page.url.pathname}"
			class="text-blue-500 hover:underline">previous version</a
		> of the app while we complete the migration.
	</p>
