...
<section class="min-h-screen bg-background">
	<div class="mx-auto flex flex-col items-center justify-center px-6 py-8 md:h-screen lg:py-0">
		...
		<div class="w-full rounded-lg border bg-card text-card-foreground shadow-sm sm:max-w-md">
			<div class="space-y-4 p-6 sm:p-8">
				<div class="flex flex-col space-y-2">
					<h1 class="text-2xl font-semibold tracking-tight">Sign in to your account</h1>
					<p class="text-sm text-muted-foreground">Enter your credentials below</p>
				</div>
